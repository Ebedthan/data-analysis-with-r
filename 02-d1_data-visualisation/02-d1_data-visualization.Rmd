...
<h2 style="text-align:center;">La visualisation des données `r emo::ji('graph')`</h2>
...
```
.question[
Quelles sont les fonctions pour déssiner le graphe? Quelles sont les données utilisées pour le graphe? Quelles sont les variables en abscisse et en ordonnée? Que signifie le warning?
]
